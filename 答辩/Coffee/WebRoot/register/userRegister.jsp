		...
		$("#adminNo").blur(function(){
			...
			$.ajax({
					...
					success:function(data){
						if(data=="true"){
							$("#adminNo").val("");
							$("#aaaaaa").html("此用户名已经被注册！");
							$("#aaaaaa").css("color","red");
						}else{
							$("#aaaaaa").html(" ");
						}
					}
        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
            	<div class="part1">                	
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input  name="userName" type="text" maxlength="20" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:3-20||isUname" data-error="用户名不能为空||用户名长度3-20位||只能输入中文、字母、数字、下划线，且以中文或字母开头" id="adminNo" onblur="aaaa()"/>
                            <span  id="aaaaaa" ></span>
                ...
                <div class="part2" style="display:none">
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                        	注册需要您的真实信息
                           <a href="javascript:;" class="btn btn-blue f-r3" id="btn_part2">同意请点我</a>                         
                        </div>
                    </div> 
                </div>
                <div class="part3" style="display:none">
                	<div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input name="realName" type="text" maxlength="10" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:2-10||isZh" data-error="真实姓名不能为空||真实姓名长度2-10位||只能输入中文" id="adminNo" />   
                            <span class="ie8 icon-close close hide"></span>                         
                            <label class="icon-sucessfill blank hide"></label>
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input name="idCard" type="text" class="txt03 f-r3 required" tabindex="2" data-valid="isNonEmpty||isCard" data-error="身份证号不能为空||身份证号码格式不正确" maxlength="18" id="phone" />    
                            <span class="ie8 icon-close close hide"></span>                        
                            <label class="icon-sucessfill blank hide"></label>
