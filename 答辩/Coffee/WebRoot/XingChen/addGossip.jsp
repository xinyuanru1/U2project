...
<script type="text/javascript">
	function isNull(){
			if($("#content11").val().length==0||$("#d1111").val().length==0||$("#goTitle11").val().length==0){
				$("#msg").html("不能有空值");
				return false;
			}
			return true;
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3>添加留言</h3>
    <form action="../GossipServlet?flag=qianAdd" method="post" onsubmit="return isNull()">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
	<tr>
		<td align="right" valign="top">留言标题</td>
		<td>
			<input type="text" name="goTitle" id="goTitle11"/>
		</td>
	...
	<tr>
       ...
       <td>
        ...
        <!-- /KindEditor -->
        <textarea id="content11" name="gossipContent" style="width:780px;height:400px;" class="textArea"></textarea>
       </td>
      </tr>
      <tr>
       <td align="right">留言时间</td>
       <td>
       <%Date date1=new Date();SimpleDateFormat s=new SimpleDateFormat("yyyy-MM-dd"); String date=s.format(date1); %>
        <input id="d1111" type="text" name="gossipTime" class="inpMain" value="<%=date %>" readonly="readonly"/>
       </td>
      </tr>
	...
	<div class="footer--1">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
				<a id="weibo_icon" onclick="ga('send', 'event', 'social icons', 'footer', 'weibo');" style="float: right; display: inline-block; width: 40px; height: 40px; border-radius: 20px; background: url('images/weibo.svg');background-size: contain;" href='#' target="_blank"></a>
