...
<script type="text/javascript">
	...
	function getCount(){
		var proTotalPrice =  $("#price").val()*$("#num").val();
		$("#proTotalPrice").val(proTotalPrice);
	}
...
<body class="lang_cn" onload="getCount()">
	...
	<div id="content">
     ...
     &nbsp&nbsp&nbsp&nbsp<h4><strong>新订单</strong></h4>
      ...
      <tr>
       ...
       <td>
        <input type="text" id="num" name="proNum" value="${coffee.coffeeNum}"  size="50" readonly="readonly" class="inpMain" /><!--<input type="button" value="+" onclick="aa()"  ><input type="button" value="-" onclick="bb()" >
       </td>
      --></td></tr>
      <tr>
       <td align="right">总价</td>
       <td>
        <input id="proTotalPrice" type="text" name="proTotalPrice"  readonly="readonly" size="50" value="javascript:getCount()" class="inpMain"/>
       </td>
      </tr>
      <tr>
