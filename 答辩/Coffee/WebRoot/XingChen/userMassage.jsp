...
<div id="wrapper">
    ...
    <table width="50%" border="0px" cellpadding="8" cellspacing="0" class="tableBasic" style="margin:auto">
      		...
      		<c:if test="${user==null}"><%request.getRequestDispatcher("false_userMassage.jsp"); %></c:if>
		    
		     	<tr ><td alidn="right">用户名：</td><td alidn="left">${user.userName}</td></tr>
		        <tr ><td alidn="right">密码：(已隐藏)</td><td alidn="left"></td></tr>
		        <tr ><td alidn="right">真实姓名(已隐藏)：</td><td alidn="left"></td></tr>
		        <tr ><td alidn="right">身份证号(已隐藏)：</td><td alidn="left" ></td></tr>
		        <tr ><td alidn="right">电话：</td><td alidn="left">${user.phone}</td></tr><p></p>
		        <tr align="center"><td></td><td alidn="right"><a href="updateUserMassage.jsp">点击修改</a></td></tr>
