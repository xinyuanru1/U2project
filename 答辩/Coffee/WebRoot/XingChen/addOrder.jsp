...
<div id="wrapper">
   ...
   <form action="../OrderServlet?flag=qAdd" method="post" onsubmit="return a()">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">    <input type="button" onclick="window.location.href='../OrderServlet?flag=qList'" value="查看订单"/>
     
     &nbsp&nbsp&nbsp&nbsp<h4><strong>添加订单</strong></h4>
      <tr>
       <td align="right">姓名</td>
       <td>
        <input type="text" name="orderName" value="${user.realName}" size="50" class="inpMain" readonly="readonly"/>
       </td>
      </tr>
      <tr>
       <td align="right">电话</td>
       <td>
        <input type="text" name="orderPhone" id="orderPhone" value="" size="50" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="right">预定时间</td>
       <td>
        <input type="text" name="orderTime" id="orderTime" value="" size="50" class="inpMain" onfocus="WdatePicker({skin:'whyGreen',minDate:'%y-%M-{%d+1}'})"/>
       </td>
      </tr>
      <tr>
       <td align="right">预订人数</td>
       <td>
        <input type="text" name="orderNum" id="orderNum" value="" size="50" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td></td>
