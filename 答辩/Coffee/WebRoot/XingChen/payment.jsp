...
<div id="wrapper">
    ...
    <table width="80%" border="0px" cellpadding="8" cellspacing="0" class="tableBasic">
		    <tr>
		        ...
		        <td align="center"><strong>数量（个）</strong></td>
		        <td align="center"><strong>总价（元）</strong></td>
		        <td align="center"><strong>收件人姓名</strong></td>
		        <td align="center"><strong>电话</strong></td>
		         <td align="center"><strong>送货地址</strong></td>
		    ...
		    <c:forEach items="${menus}" var="menu">
      		...
      		<tr>
		        ...
		        <td align="center">${menu.proTotalPrice}</td>
		            <td align="center">${menu.userName}</td>
		              <td align="center">${menu.userPhone}</td>
		              <td align="center">${menu.userAddress}</td>
		                <td align="center">${menu.menuStatu}</td>
		        <td align="center">
		        	<a href="../CoffeeServlet?flag=detail&proName=${menu.proName}">查看</a>
		        	<c:if test="${menu.menuStatu == '未支付'}">
		        		<a href="../MenuServlet?flag=deletel&menuNo=${menu.menuNo}" onclick="alert('确认删除？')">删除</a>I
		        		I<a href="../MenuServlet?flag=pay&menuNo=${menu.menuNo}">支付</a>
		        	</c:if>
		        </td>
		    </tr>
		    </c:forEach>
    ...
    <c:if test="${pageIndex>1}">
    	<a href="../MenuServlet?flag=list">第一页</a>
    	<a href="../MenuServlet?flag=list&pageIndex=${pageIndex-1}">上一页</a> 
    </c:if>
   	<c:if test="${pageIndex<totalPage}">
   		<a href="../MenuServlet?flag=list&pageIndex=${pageIndex+1}">下一页 </a> 
   		<a href="../MenuServlet?flag=list&pageIndex=${totalPage}">最末页</a>
   	</c:if>
