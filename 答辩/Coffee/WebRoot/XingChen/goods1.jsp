...
<head>
<meta charset="utf-8"/>
<title>${coffee.coffeeName} | 星辰</title>
...
<div id="wrapper">
	<div id="content">
		...
		<header class="section menu__item-header"  >
		...
		<div class="container" >
			<div class="row" >
				<div class="col-sm-6">
					...
					￥${coffee.coffeePrice}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="addPayment.jsp"><h5 style="color:red">立即购买</h5>
					</a> <a href="../GouWuCheServlet?flag=gouWuChe&coffeeNo=${coffee.coffeeNo}"><h5 style="color:red">加入购物车</h5></a> 
				</div>
