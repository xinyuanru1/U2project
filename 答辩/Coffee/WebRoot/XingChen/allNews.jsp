...
<div id="wrapper">
	<div id="content">
		...
		<div class="container">
			<c:forEach items="${newss}" var="newsss">
			<div class="row">
				<div class="col-md-5">
					<!-- <a href="#">
					<img src="picture/starbucks-wechat-social-gifting.jpg" width="100%" alt="">
					</a> -->
    ...
    <c:if test="${pageIndex>1}">
    	<a href="../NewsServlet?flag=reGetAll">第一页</a>
    	<a href="../NewsServlet?flag=reGetAll&pageIndex=${pageIndex-1}">上一页</a> 
    </c:if>
   	<c:if test="${pageIndex<totalPage}">
   		<a href="../NewsServlet?flag=reGetAll&pageIndex=${pageIndex+1}">下一页 </a> 
   		<a href="../NewsServlet?flag=reGetAll&pageIndex=${totalPage}">最末页</a>
   	</c:if>
