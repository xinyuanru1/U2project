...
<script type="text/javascript">
     ...
     $(".jia").click(function(){changeNumber(this,true);});
      $(".jian").click(function(){changeNumber(this,false);});
     })
</script>
...
<div id="wrapper">
	<div id="content">
       ...
       购物车商品：
    <table id="shopTable" width="80%" border="0px" cellpadding="8" cellspacing="0" class="tableBasic">
		    <tr>
		    ...
		    <c:if test="${coffee.value.buyerId==user.id}">
		    	<tr id="tr${statu.index}">
			        ...
			        <td  size="5" class="inpMain" align="center" > 
			        	<button class="jia">+</button><input type="text" style="width:20px" id="proNum" value="1" name="aaaaa"/><button class="jian">-</button>
