...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <li class="cur"><a href="product.html"><i class="product"></i><em>用户列表</em></a></li>
 </ul>
  <ul>
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <th width="80" align="center">电话</th>
        ...
        <th width="280" align="center">身份证号</th>
      </tr>
      <tr>
        <td align="center"><input type="checkbox" name="checkbox[]" value="15" /></td>
        <td align="center">id</td>
        <td>xinyuanru1</td>
        <td align="center">shijiaqi6</td>
        <td align="center">13091261752</td>
        <td align="center">史嘉麒</td>
        <td align="center">130604199110121216</td>
      </tr>
          </table>
    <div class="action">
...
<div id="dcFooter">
 <div id="footer">
  <div class="line"></div>
  <ul>
   版权所有 © 2013-2015 漳州豆壳网络科技有限公司，并保留所有权利。 <a href="http://www.sucainiu.com">素材牛 - 后台模版</a>
  </ul>
 </div>
</div><!-- dcFooter 结束 -->
