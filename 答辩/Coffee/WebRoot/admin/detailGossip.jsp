...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
     ...
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
       ...
       <td>${gossip.gossipNo}</td>
      </tr>
      <tr>
       <td width="100" align="right">发表时间</td>
        <td>${gossip.gossipTime}</td>
      </tr>
      <tr>
       <td width="100" align="right">发表主题</td>
        <td>${gossip.gossipTitle}</td>
      </tr>
      <tr>
       <td width="100" align="right">发表内容</td>
        <td>${gossip.gossipContent}</td>
      </tr>
      <tr>
      ...
      <tr>
       <td width="100" align="right">回复时间</td>
        <td>${gossip.replyTime}</td>
      </tr>
      <tr>
       <td></td>
       <td>
