...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3>修改预定</h3>
    <form action="../OrderServlet?flag=update&orderNo=${order.orderNo}" method="post" onsubmit="return isNull()">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
		<tr>
       <td width="100" align="right">姓名</td>
       <td>
        <input id="proName" type="text" name="orderName" value="${order.orderName}" size="20" class="inpMain" style="height:30px"/>
       </td>
      </tr>
     <tr>
       <td width="100" align="right">电话</td>
       <td>
        <input id="proPhone" type="text" name="orderPhone" value="${order.orderPhone}" size="20" class="inpMain" style="height:30px"/>
       </td>
      </tr>
      <tr>
       <td width="100" align="right">预定时间</td>
       <td>
        <input id="proTime" type="text" name="orderTime" value="${order.orderTime}" size="20" class="inpMain" style="height:30px" onClick="WdatePicker()"/>
       </td>
      </tr>
      <tr>
       <td width="100" align="right">预定人数</td>
       <td>
        <input id="proNum" type="text" name="orderNum" value="${order.orderNum}" size="20" class="inpMain" style="height:30px"/>
       </td>
      </tr>
      <tr>
       <td id="msg"></td>
