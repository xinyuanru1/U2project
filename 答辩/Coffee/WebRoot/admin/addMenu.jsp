...
<script type="text/javascript">
	function isNull(){
			...
			if($("#proName").val().length==0||$("#proPhone").val().length==0||$("#d11").val().length==0
			||$("#proNum").val().length==0||$("#userPhone").val().length==0||$("#userAddress").val().length==0){
				$("#msg").html("不能有空值");
				return false;
			}
			return true;
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3>添加订单</h3>
    <form action="../MenuServlet?flag=add" method="post" onsubmit="return isNull()">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td align="right">用户名</td>
       <td>
        <input type="text" name="userName" value="" size="50" class="inpMain" id="proName"/>
       </td>
      </tr>
      <tr>
       <td align="right">产品名称</td>
       <td>
        <input type="text" name="proName" value="" size="50" class="inpMain" id="proPhone"/>
       </td>
      </tr>
      <tr>
       <td align="right">单价</td>
       <td>
        <input id="d11" type="text" name="proPrice" class="inpMain"/>
       </td>
      </tr>
      <tr>
       <td align="right">数量</td>
       <td>
        <input id="d11" type="text" name="proNum" class="inpMain"/>
       </td>
      </tr>
      <tr>
       <td align="right">总价</td>
       <td>
        <input id="d11" type="text" name="proTotalPrice" class="inpMain"/>
       </td>
      </tr>
      <tr>
       <td align="right">用户电话</td>
       <td>
        <input type="text" name="userPhone" value="" size="50" class="inpMain" id="userPhone"/>
       </td>
      </tr>
      <tr>
       <td align="right">送餐地址</td>
       <td>
        <input id="userAddress" type="text" name="userAddress" class="inpMain"/>
       </td>
      </tr>
      <tr>
       <td id="msg"></td>
