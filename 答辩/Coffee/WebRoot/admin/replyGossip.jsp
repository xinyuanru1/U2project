...
<script type="text/javascript">
	function isNull(){
			...
			if($("#d11").val().length==0||$("#proText").val().length==0){
				$("#msg").html("不能有空值");
				return false;
			}
			return true;
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3>修改留言信息</h3>
    <form action="../GossipServlet?flag=doReply&gossipNo=${gossip.gossipNo}" method="post"  onsubmit="return isNull()">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
		<tr>
       <td width="100" align="right">留言时间</td>
       <td>
        <input id="d11" type="text" name="gossipTime" readonly="readonly" value="${gossip.gossipTime}" size="20" class="inpMain" style="height:30px"/>
       </td>
      </tr>
     <tr>
       <td width="100" align="right">留言内容</td>
       <td>
      	<textarea rows="10" cols="30" readonly="readonly" name="gossipContent" class="inpMain">${gossip.gossipContent}</textarea>
       </td>
      </tr>
      <tr>
       <td width="100" align="right">回复内容</td>
       <td>
      	<textarea rows="10" cols="30" name="replyContent" id="proText" class="inpMain"></textarea>
       </td>
      </tr>
      <tr>
       <td id="msg"></td>
