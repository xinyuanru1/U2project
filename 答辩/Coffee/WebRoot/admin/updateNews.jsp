...
<script type="text/javascript">
	function isNull(){
			...
			if($("#proTitle").val().length==0||$("#proText").val().length==0){
				$("#msg").html("不能有空值");
				return false;
			}
			return true;
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3>添加新闻</h3>
    <form action="../NewsServlet?flag=update&newsNo=${news.newsNo}" method="post"  onsubmit="return isNull()">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
		<tr>
       <td width="100" align="right">新闻标题</td>
       <td>
        <input id="proTitle" type="text" name="newsTitle" value="${news.newsTitle}" size="20" class="inpMain" style="height:30px"/>
       </td>
      </tr>
     <tr>
       <td width="100" align="right">新闻内容</td>
       <td>
      	<textarea rows="10" cols="30" name="newsContent" class="inpMain" id="proText">${news.newsContent}</textarea>
       </td>
      </tr>
      <tr>
       <td id="msg"></td>
